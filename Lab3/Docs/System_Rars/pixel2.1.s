...
MAIN:
	...
	li 	s4, 1 # status de pintar atual (0 = false, 1 = true)
	...
	MAINLOOP:
		...
		LEFT3:
			...
			bnez	s4, LEFT3continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
		...
		LEFT2continue:
			...
			bnez	s4, LEFT2continue1 # se pintar == true, pinta 2 px de branco
			li	t0, preto
			sb	t0, 0(a0)	#preenche a posicaoo atual com preto
			j LEFT2continue2
		...
		LEFT1continue:
			...
			bnez	s4, LEFT1continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0, 0(a0)	#preenche a posi��o atual com preto
		...
		RIGHT1continue:
			...
			bnez	s4, RIGHT1continue1 # se pintar == true, nao preenche pos de preto
			li	t0, preto
		...
		RIGHT2continue:
			...
			bnez	s4, RIGHT2continue1 # se pintar == true, nao pinta px preto e pinta px brancos
			li	t0, preto	
			sb	t0, 0(a0)	#preenche a pos atual com preto
			j RIGHT2continue2
		...
		RIGHT3continue:
			...
			bnez	s4, RIGHT3continue1 # se pintar == true, nao pinta px atual de preto
		...
		UP3:
			...
			bnez	s4, UP3continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0, 0(a0)	#preenche a posi��o atual com preto
			j UP3continue2
			
			UP3continue1: # pinta px da linha de branco
			li	t0, branco
			sb	t0, -320(a0)
			sb	t0, -640(a0)
			sb	t0, -960(a0)
		...
		UP2continue:
			...
			bnez	s4, UP2continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0, 0(a0)	#preenche a posi��o atual com preto
			j UP2continue2
			
			UP2continue1: # pinta px da linha de branco
			li	t0, branco
			sb	t0, -320(a0) # -1px
			sb	t0, -640(a0) # -2px
		...
		UP1continue:
			...
			bnez	s4, UP1continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0, 0(a0)	#preenche a posi��o atual com preto
		...
		DOWN1continue:
			...
			bnez	s4, DOWN1continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0, 0(a0)	#preenche a pos atual com preto
		...
		DOWN2continue:
			...
			bnez	s4, DOWN2continue1 # se pintar == true, nao pinta px de preto
			li	t0, preto
			sb	t0, 0(a0)
			j DOWN2continue2
			
			DOWN2continue1: # pinta px abaixo de branco
			li	t0, branco
			sb	t0, 320(a0)
			sb	t0, 640(a0)
		...
		DOWN3continue:
			...
			bnez	s4, DOWN3continue1 # se pintar == true, nao pinta px atual de preto
			li	t0, preto
			sb	t0,0(a0)
			j DOWN3continue2
			
			DOWN3continue1: # pinta linhas abaixo de branco
			li	t0, branco
			sb	t0, 320(a0)
			sb	t0, 640(a0)
			sb	t0, 960(a0)
